<?php
 function adminForm() {
  ...
  echo '<p></p><hr size="2">';
  echo '<h3>Example</h3>';
  echo '<p><strong>from:</strong> &amp;copy; 2008 Annubis Blog World - &lt;a href="http://blog.schweizer-web.ch"&gt;Annubis Blog&lt;/a&gt;</p>';
  echo '<p><strong>you would get this output:</strong> &copy; 2008 Annubis Blog World - <a href="http://blog.schweizer-web.ch/">Annubis Blog</a></p><hr size="2">';
  echo '<h3>Optionen</h3>';
  if ($_REQUEST['submit']) {
   saveForm();
  }
...
//  echo '</form>  ';
 ...
 // echo '<form method="post">';
  ...
  echo 'Weitere Informationen unter <a href="http://blog.schweizer-web.ch" target="_blank">Plugin Seite</a>';
